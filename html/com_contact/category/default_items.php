			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
					<?php if ($this->items[$i]->published == 0) : ?>
						<li class="my-2 list-group-item system-unpublished cat-list-row<?php echo $i % 2; ?>">
								<?php else : ?>
						<li class="my-2 list-group-item cat-list-row<?php echo $i % 2; ?>" >
						<?php endif; ?>
						...
						<div class="row">
							...
							<div class="col-sm-5">
								...
								<div class="list-title span<?php echo $contact_width; ?> col-md-<?php echo $contact_width; ?>">
									<a class="lead text-info" href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid)); ?>">
									...
									<?php if ($this->params->get('show_position_headings')) : ?>
											<span class="lead text-danger"><?php echo $item->con_position; ?></span><br />
									<?php endif; ?>
								...
								<div class="col-md-4">
									...
									<?php if ($this->params->get('show_suburb_headings') && !empty($item->suburb)) : ?>
										<i class="material-icons text-warning" style="font-size: 2rem;">location_on</i>
									...
									<?php if ($this->params->get('show_telephone_headings') && !empty($item->telephone)) : ?>
										<i class="material-icons text-warning" style="font-size: 2rem;">phone</i>
