...
abstract class JHtmlBootstrap
{
	...
	public static function startAccordion($selector = 'myAccordian', $params = array())
	{
		if (!isset(static::$loaded[__METHOD__][$selector]))
		{
			...
			return '<div role="tablist" id="' . $selector . '" class="accordion">';
		}
	}
	...
	public static function addSlide($selector, $text, $id, $class = '')
	{
		...
		$html = '<div class="card accordion-group' . $class . '">'
			. '<div class="card-header role="tab" accordion-heading">'
			. '<strong class="lead text-info"><a href="#' . $id . '" data-toggle="collapse"' . $parent . ' class="accordion-toggle' . $collapsed . '">'
			. $text
			. '</a></strong>'
			. '</div>'
